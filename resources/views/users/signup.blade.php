          ...
          <div class="d-flex justify-content-center align-items-center flex-column">
            ...
            <div class="mb-3">
              ...
              <div class="login-input border d-flex p-2 align-items-center">
                <img src="{{ asset('assets/images/signupimages/Vector (1).png')}}" class=" login-logo mx-1" alt="" height="21" width="25">
                <input type="text" name="firstname" class="form-control d-block fs-5  rounded-0  input border border-0" id="firstName" placeholder="Johan" value ="{{old('firstname')}}">
              </div>
            ...
            <div class="mb-3">
              ...
              <div class="login-input border d-flex p-2 align-items-center">
                <img src="{{ asset('assets/images/signupimages/Vector (1).png') }}" class=" login-logo mx-1" alt="" height="21" width="25">
                <input type="text" class="form-control d-block fs-5  rounded-0  input border border-0" id="lastName" name="lastname" placeholder="Deo"  value ="{{old('lastname')}}">
              </div>
              <span class="error text-danger">
              @error('lastname')
                {{$message}}
            ...
            <div class="mb-3">
              ...
              <div class="login-input border d-flex p-2 align-items-center">
                ...
                <input type="text" class="form-control d-block fs-5  rounded-0  input border border-0" id="exampleInputEmail13" name="email" placeholder="example.com" value ="{{old('email')}}">
              </div>
              <span class="error text-danger">
              @error('email')
                {{$message}}
            ...
            <div class="mb-3">
              ...
              <div class="login-input border d-flex p-2 align-items-center">
                <img src="{{ asset('assets/images/signupimages/Suche (1).png') }}" class=" login-logo mx-1" alt="" height="14" width="26">
                <input type="password" class="form-control d-block fs-5 rounded-0  input border border-0" name="password" placeholder="Enter passwords">
                <img src="{{ asset('assets/images/signupimages/Suche (2).png') }}" class="ms-auto ps-2" alt="">
              </div>
              <span class="error text-danger">
              @error('password')
                {{$message}}
                ...
                <select class="form-select border-0 fs-5" aria-label="Default select example" name="country">
                  <option value="">Select your country</option>
                    @foreach($country as $countries)
                      <option value="{{ $countries->id }}" {{ old('country') == $countries->id ? 'selected' : '' }}>{{ $countries->country }}</option>
                    @endforeach 
                </select>
            ...
            <div class="mb-1">  
              ...
              <div class="login-input d-flex gap-2">
                <input class="form-check-input" type="radio" name="gender" value="male" id="flexRadioDefault1"  {{ old('gender') == 'male' ? 'checked' : '' }}>
                <label class="form-check-label text-secondary fw-bold fs-6" for="flexRadioDefault1">
                  Male
                </label>
                <input class="form-check-input ms-2" type="radio" name="gender" value="female" id="flexRadioDefault12" {{old('gender')=='female'? 'checked' : ''}}>
                <label class="form-check-label text-secondary fw-bold fs-6" for="flexRadioDefault1">
                  Female
                </label>
                <input class="form-check-input ms-2" type="radio" name="gender" value="other" id="flexRadioDefault12" {{old('gender')=='other'? 'checked' : ''}}>
                <label class="form-check-label text-secondary fw-bold fs-6" for="flexRadioDefault1">
                  Other
                </label>
              </div>
            ...
            <div class="mb-3 form-check pt-3 pb-3">
              ...
              <label class="form-check-label text-secondary fw-bold fs-6 lh-base ps-1 pt-1" for="exampleCheck1">I have
                read the <a class="link-dark link-offset-2 link-underline-opacity-50 link-underline-secondary">Terms
                  & Conditions</a>
              </label>
            </div>
            ...
            <button type="button" class="btn text-black fw-bold fs-5 btn-outline-secondary rounded-1 mt-3 btn-lg form-btn">
              <img src="{{ asset('images/signupimages/icons8-google-48.png') }}" alt="" height="28">
              Continue
              with Google
            </button>
            <div class="pt-3 ">
              <p class="text-black fw-bold fs-5">Don't have an account yet? <a  class="link-primary link-offset-2 fw-bold link-underline-opacity-0">Sign In</a></p>
            </div>
          </div>
